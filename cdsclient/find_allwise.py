...
"""G.Landais (CDS) 24-mar-2018
   ...
   find_allwise.py [-h] [-a] [-r radius] [-m max] [constraints] [--format=tsv|votable|ascii] [position]
...
class QueryCatClient(QueryCat):
    ...
    def query_cat(self, constraints=None, all=False, limit=vizquery.DEFAULT_LIMIT, columns=None, filename=None):
        ...
        self.__url = VIZIER_BIG_CAT_URL + "?-source=ALLWISE"
...
if __name__ == "__main__":
    ...
    __options = ('help','format=','sort','add=','file=','RAJ2000=','DEJ2000=','Jmag=','Hmag=','Kmag=','ipix=','no-format','offset=')
    try :
