...
if __name__ == "__main__":
    ...
    __options = ('help','format=','sort','add=','file=','b=','bp_g=','bp_rp=','dec=','dec_epoch2000=','g_rp=','l=','parallax=','parallax_error=','parallax_over_error=','phot_bp_mean_mag=','phot_g_mean_mag=','phot_rp_mean_mag=','pmdec=','pmra=','ra=','radial_velocity=','radial_velocity_error=','ra_epoch2000=','random_index=','ref_epoch=','source_id=','ipix=','no-format','offset=')
    try :
