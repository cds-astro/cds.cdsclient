...
if __name__ == "__main__":
    ...
    __options = ('help','format=','sort','add=','file=','ra=','dec=','source_id=','random_index=','ref_epoch=','parallax=','parallax_error=','parallax_over_error=','pmra=','pmdec=','phot_g_mean_mag=','phot_bp_mean_mag=','phot_rp_mean_mag=','bp_rp=','bp_g=','g_rp=','radial_velocity=','radial_velocity_error=','l=','b=','ra_epoch2000=','dec_epoch2000=','ipix=','no-format','offset=')
    try :
