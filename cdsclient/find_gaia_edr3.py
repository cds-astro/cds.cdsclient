...
if __name__ == "__main__":
    ...
    __options = ('help','format=','sort','add=','file=','Plx=','RVDR2=','Source=','RandomI=','RAJ2000=','RA_ICRS=','pmRA=','pmDE=','RPmag=','Gmag=','BPmag=','RPlx=','e_Plx=','GLON=','G-RP=','e_RVDR2=','DEJ2000=','DE_ICRS=','BP-RP=','BP-G=','GLAT=','ipix=','no-format','offset=')
    try :
