...
if __name__ == "__main__":
    ...
    __options = ('help','format=','sort','add=','file=','RA_ICRS=','DE_ICRS=','Source=','RandomI=','Epoch=','Plx=','e_Plx=','RPlx=','pmRA=','pmDE=','Gmag=','BPmag=','RPmag=','BP-RP=','BP-G=','G-RP=','RVDR2=','e_RVDR2=','GLON=','GLAT=','RAJ2000=','DEJ2000=','ipix=','no-format','offset=')
    try :
