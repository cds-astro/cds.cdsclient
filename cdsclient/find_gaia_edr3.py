...
if __name__ == "__main__":
    ...
    __options = ('help','format=','sort','add=','file=','GLAT=','BP-G=','BP-RP=','DE_ICRS=','DEJ2000=','RVDR2=','e_RVDR2=','G-RP=','GLON=','Plx=','e_Plx=','RPlx=','BPmag=','Gmag=','RPmag=','pmDE=','pmRA=','RA_ICRS=','RAJ2000=','RandomI=','Epoch=','Source=','ipix=','no-format','offset=')
    try :
