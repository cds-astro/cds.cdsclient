...
if __name__ == "__main__":
    ...
    __options = ('help','format=','sort','add=','file=','noheader','RA_ICRS=','DE_ICRS=','SDSS12=','SDSS-ID=','objID=','Sp-ID=','ObsDate=','umag=','gmag=','rmag=','imag=','zmag=','zsp=','zph=','ipix=','no-format','offset=')
    try :
