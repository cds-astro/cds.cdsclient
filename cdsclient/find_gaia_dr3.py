...
if __name__ == "__main__":
    ...
    __options = ('help','format=','sort','add=','file=','Plx=','Gmag=','PS1coid=','APASS9coid=','RPlx=','TYC2=','Source=','RV=','GLON=','URAT1=','RAVE5=','RAVE6=','AllWISE=','2MASS=','RA_ICRS=','RPmag=','GSC23=','DEJ2000=','DE_ICRS=','pmRA=','BPmag=','HIP=','APASS9=','GLAT=','RAJ2000=','pmDE=','BP-G=','G-RP=','BP-RP=','ipix=','no-format','offset=')
    try :
