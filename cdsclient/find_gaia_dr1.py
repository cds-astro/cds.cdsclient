...
if __name__ == "__main__":
    ...
    __options = ('help','format=','sort','add=','file=','b=','dec=','dec_error=','l=','parallax=','phot_g_mean_flux=','phot_g_mean_flux_error=','phot_g_mean_mag=','pmdec=','pmRA=','ra=','ra_error=','source_id=','ipix=','no-format','offset=')
    try :
