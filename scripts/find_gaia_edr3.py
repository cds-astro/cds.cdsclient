...
if __name__ == "__main__":
    ...
    __options = ('help','format=','sort','add=','file=','GLAT=','BP-G=','BP-RP=','DE_ICRS=','DEJ2000=','RVDR2=','G-RP=','GLON=','Plx=','e_Plx=','RPlx=','pmDE=','pmRA=','RA_ICRS=','RAJ2000=','RandomI=','Source=','ipix=','no-format')
    try :
