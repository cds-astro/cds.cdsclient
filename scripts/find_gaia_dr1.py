...
if __name__ == "__main__":
    ...
    __options = ('help','format=','sort','add=','file=','ra=','ra_error=','dec=','dec_error=','source_id=','parallax=','pmRA=','pmdec=','phot_g_mean_flux=','phot_g_mean_flux_error=','phot_g_mean_mag=','l=','b=','ipix=','no-format')
    try :
